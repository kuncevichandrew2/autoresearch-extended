...
Один блок AskUserQuestion — один вопрос. Опции пред-набрасываются из репо: пользователь выбирает, а не печатает. Между вызовами — думать: что репо уже говорит? Сформировать конкретное предложение до вопроса — вопрос должен нести готовый вариант и приглашать к правке, а не перекладывать решение на пользователя.
